...
# Quick Summary Table
  ...
  strip(), lstrip(),       Remove whitespace
  rstrip()                 

  find(), index()          Locate substring (`find()` returns `-1`;
  ...
  isalnum(), isalpha(),    Character validation
  isdigit()                

  islower(), isupper(),    Case and whitespace checks
  istitle(), isspace()     
  -----------------------------------------------------------------------
